// Refer to: https://nullprogram.com/blog/2017/01/08/
//gcc -std=c99 -D_DEFAULT_SOURCE -Os -o cb_ctxts cb_ctxts.c -lm
#if (!defined(__unix__) && !defined(__APPLE__)) || (!defined(__x86_64__) && !defined(__arm__)) 
#  error Requires x86_64 or ARM and System V ABI
#endif
