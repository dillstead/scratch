// gcc -Werror -pedantic -std=c99 -Wall -Wextra -Wno-error=unused-parameter -Wno-error=unused-function -Wno-error=unused-variable -Wconversion -Wno-error=sign-conversion -fsanitize=address,undefined -g3 -o problem24b problem24b.c
// gcc -Werror -pedantic -std=c99 -Wall -Wextra -Wno-error=unused-parameter -Wno-error=unused-function -Wno-error=unused-variable -O2 -o problem24b problem24b.c
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
#include <stdbool.h>
...
int main(void)
{
    ...
    int end_min;
    int total_mins = find_path(START_ROW, START_COL, END_ROW, END_COL, 0, &end_min);
    total_mins += find_path(END_ROW, END_COL, START_ROW, START_COL, 0, &end_min);
    total_mins += find_path(START_ROW, START_COL, END_ROW, END_COL, 0, &end_min);
    printf("%d\n", total_mins);
    return EXIT_SUCCESS;
}
