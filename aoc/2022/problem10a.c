// gcc -Werror -pedantic -std=c99 -Wall -Wextra -fsanitize=address,undefined -g3 -o problem10a problem10a.c
#include <stdlib.h>
#include <stdio.h>
#include <inttypes.h>
#include <string.h>

#define TARGET_INIT    20
#define TARGET_INC     40
...
unsigned int target = TARGET_INIT;
